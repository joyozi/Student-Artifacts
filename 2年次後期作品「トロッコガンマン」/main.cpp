...
#define WINDOW_NAME	"!!!!!!!!!!!!!!トロッコガンマン!!!!!!!!!!!!!!"				//(ウィンドウの名前)
#define BACKGROUND_COLOR_R	(0)				//背景の色
#define BACKGROUND_COLOR_G	(0)				//背景の色
#define BACKGROUND_COLOR_B	(0)				//背景の色
#define BACKGROUND_COLOR_A	(0)				//背景の色
...
void Draw(void)
{
	g_pD3DDevice->Clear(0,NULL,(D3DCLEAR_TARGET|D3DCLEAR_ZBUFFER),D3DCOLOR_RGBA(BACKGROUND_COLOR_R,BACKGROUND_COLOR_G,BACKGROUND_COLOR_B,BACKGROUND_COLOR_A),1.0f,0);	//クリアする色
