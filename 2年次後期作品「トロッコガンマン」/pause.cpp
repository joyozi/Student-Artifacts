...
void InitPause(void)
{
	...
	p_pVtx[0].col = D3DCOLOR_RGBA(255,255,255,150);
	p_pVtx[1].col = D3DCOLOR_RGBA(255,255,255,150);
	p_pVtx[2].col = D3DCOLOR_RGBA(255,255,255,150);
	p_pVtx[3].col = D3DCOLOR_RGBA(255,255,255,150);
	...
	//頂点情報の設定
	p_pVtx[0].pos = D3DXVECTOR3(250+TYOUSEI,350,0.0f);
	p_pVtx[1].pos = D3DXVECTOR3(500+TYOUSEI,350,0.0f);
	p_pVtx[2].pos = D3DXVECTOR3(250+TYOUSEI,450,0.0f);
	p_pVtx[3].pos = D3DXVECTOR3(500+TYOUSEI,450,0.0f);
...
//	D3DXCreateTextureFromFile(GetDevice(),"./data/TEXTURE/explosion.png",&p_pTexturePolygon[1]);
	...
	//頂点情報の設定
	p_pVtx[0].pos = D3DXVECTOR3(150+TYOUSEI,150,0.0f);
	p_pVtx[1].pos = D3DXVECTOR3(600+TYOUSEI,150,0.0f);
	p_pVtx[2].pos = D3DXVECTOR3(150+TYOUSEI,350,0.0f);
	p_pVtx[3].pos = D3DXVECTOR3(600+TYOUSEI,350,0.0f);
	...
	//頂点情報の設定
	p_pVtx[0].pos = D3DXVECTOR3(250+TYOUSEI,450,0.0f);
	p_pVtx[1].pos = D3DXVECTOR3(500+TYOUSEI,450,0.0f);
	p_pVtx[2].pos = D3DXVECTOR3(250+TYOUSEI,550,0.0f);
	p_pVtx[3].pos = D3DXVECTOR3(500+TYOUSEI,550,0.0f);
	...
	//頂点情報の設定
	p_pVtx[0].pos = D3DXVECTOR3(250+TYOUSEI,550,0.0f);
	p_pVtx[1].pos = D3DXVECTOR3(500+TYOUSEI,550,0.0f);
	p_pVtx[2].pos = D3DXVECTOR3(250+TYOUSEI,650,0.0f);
	p_pVtx[3].pos = D3DXVECTOR3(500+TYOUSEI,650,0.0f);
...
void UpdatePause(void)
{
	...
	//頂点情報の設定
	p_pVtx[0].pos = D3DXVECTOR3(250+TYOUSEI,350 + (g_selectMenu * 100),0.0f);
	p_pVtx[1].pos = D3DXVECTOR3(500+TYOUSEI,350 + (g_selectMenu * 100),0.0f);
	p_pVtx[2].pos = D3DXVECTOR3(250+TYOUSEI,450 + (g_selectMenu * 100),0.0f);
	p_pVtx[3].pos = D3DXVECTOR3(500+TYOUSEI,450 + (g_selectMenu * 100),0.0f);
