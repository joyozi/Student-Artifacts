...
int r_nCounterAnim = 0;
int r_nPatternAnim = 0;
int r_nPatternAnimTATE = 0;
...
void InitResultPolygon(bool Judge)
{
	...
	//頂点情報の設定
	r_pVtx[0].pos = D3DXVECTOR3(50.0f,30.0f,0.0f);
	r_pVtx[1].pos = D3DXVECTOR3(1050.0f,30.0f,0.0f);
	r_pVtx[2].pos = D3DXVECTOR3(50.0f,300.0f,0.0f);
	r_pVtx[3].pos = D3DXVECTOR3(1050.0f,300.0f,0.0f);
	...
	if(Judge)
	{
		D3DXCreateTextureFromFile(GetDevice(),"./data/TEXTURE/goal_000.png",&r_pTexturePolygon);
	}
	else
	{
		D3DXCreateTextureFromFile(GetDevice(),"./data/TEXTURE/GameOverLogo00.png",&r_pTexturePolygon);
	}
